...
openstack server create --key-name osa_key  --flavor baremetal-flavor --image $guest_ubuntu_filename  --nic net-id=$NET_IRONIC_UUID baremetal
openstack server create --key-name osa_key  --flavor baremetal-flavor --image $guest_ubuntu_filename  --nic net-id=$NET_IRONIC_UUID baremetal

openstack server create --key-name osa_key --flavor virtual-flavor --security-group server_ssh_icmp --image $guest_filename --nic net-id=$NET_DUMMY_UUID virtual
